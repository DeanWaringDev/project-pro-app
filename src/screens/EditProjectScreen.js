...
export default function EditProjectScreen({ project, onClose, onSuccess }) {
  ...
  const renderCalendar = () => {
    ...
    const selectDate = (day) => {
      ...
      console.log('Updated deadline selected:', selectedDate.toDateString());
    };
        ...
        <View style={styles.calendarFooter}>
          <TouchableOpacity
            onPress={() => {
              setDeadline(null);
              setShowDatePicker(false);
              console.log('Project deadline cleared');
            }}
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          console.log('Project priority updated to:', option.value);
        }}
        style={[
